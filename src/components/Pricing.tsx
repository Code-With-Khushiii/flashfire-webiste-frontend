...
//   return (
//     <>
//      <section id="pricing" className="scroll-mt-28 py-1 sm:py-10 bg-gradient-to-b from-white to-gray-50">
...
//                         <span
//                           className= "bg-orange-50 text-orange-700 border-orange-20 inline-flex items-center rounded-full border px-3 py-1 text-xs font-medium">
...
const Pricing = () => {
  ...
  const addonsPricing = {
    Ignite: [
      { label: "+250 Applications", price: 130, paymentLink: "https://www.paypal.com/ncp/payment/ZTFDFLX4LDXRN" },
      { label: "+500 Applications", price: 220, paymentLink: "https://www.paypal.com/ncp/payment/N9UN59NZ4TCZ6" },
      { label: "+1000 Applications", price: 380, paymentLink: "https://www.paypal.com/ncp/payment/5RLLXWWV7KBL2" },
    ],
    Professional: [
      { label: "+250 Applications", price: 120, paymentLink: "https://www.paypal.com/ncp/payment/95X9FAUHTUPM4" },
      { label: "+500 Applications", price: 200, paymentLink: "https://www.paypal.com/ncp/payment/58R6C59U8LBMS" },
      { label: "+1000 Applications", price: 350, paymentLink: "https://www.paypal.com/ncp/payment/QCQ5JTXK9ZY5L" },
    ],
    Executive: [
      { label: "+250 Applications", price: 110, paymentLink: "https://www.paypal.com/ncp/payment/R3UJGRAV9363A" },
      { label: "+500 Applications", price: 190, paymentLink: "https://www.paypal.com/ncp/payment/JNJ7Y36YDSGYW" },
      { label: "+1000 Applications", price: 330, paymentLink: "https://www.paypal.com/ncp/payment/2RZEKDPESWA5A" },
    ],
  }
  ...
  const upgradePaths = [
    {
      ...
      paymentLink: "https://www.paypal.com/ncp/payment/7Z7GT5CF75L3A",
    },
    {
      from: "Professional",
      to: "Executive",
      ...
      paymentLink: "https://www.paypal.com/ncp/payment/VR5YKZW26JUEL",
    },
    {
      from: "Ignite",
      to: "Executive",
      ...
      paymentLink: "https://www.paypal.com/ncp/payment/AHW9DGNYWABZ4",
    },
  ]
  const teamMembers = [
    {
              ...
              >
                {addonsPricing[selectedPlan!].map((addon, index) => (
                  ...
                  >
                    ...
                    {/* Select Button */}
                    <button
                      onClick={() => handlePayment(addon.paymentLink)}
                ...
                {upgradePaths
                  ...
                  .map((path, index) => (
                    ...
                    >
                      ...
                      <button
                        onClick={() => handlePayment(path.paymentLink)}
